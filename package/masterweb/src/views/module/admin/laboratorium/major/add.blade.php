...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
        <form enctype="multipart/form-data" class="forms-sample" action="{{route('elits-majors.store')}}"  method="POST">
            @csrf
            <div class="form-group">
                <label for="name_major">Name Major</label>
                <input type="text" class="form-control" id="name_major" name="name_major" placeholder="Name Major" required >
            </div>
