        ...
        @foreach ($table as $mytable)
            <tr>
                <td style="text-align: center;vertical-align: top;">
                    {{ explode('/', $mytable['sample_type']->codesample_samples)[2] }}</td>
                <td style="text-align: center;vertical-align: top;">{!! $mytable['sample_type']->location_samples !!}</td>

                @foreach ($mytable['result'] as $result)
                    <td style="text-align: center;vertical-align: top;">{!! cek_hasil_color(
