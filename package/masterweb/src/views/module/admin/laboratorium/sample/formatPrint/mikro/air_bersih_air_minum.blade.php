...
<head>
    ...
    <title>MIKRO-{!! $data["no_agenda"] !!}</title>
...
<body style="margin: 0 10px; padding: 0">
    ...
    @include('masterweb::module.admin.laboratorium.sample.formatPrint.mikro._head_data_gabungan')
    <br>

    @include('masterweb::module.admin.laboratorium.sample.formatPrint.mikro._table_result_gabungan')
