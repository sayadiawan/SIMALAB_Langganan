<table class="result" width="98%" border="3" cellspacing="0" cellpadding="0">
    <tr>
        ...
        <td class="td-result" style="text-align: center; width: 24%; border-bottom: 2px solid black;" rowspan="3">LOKASI</td>
    ...
    @foreach ($table as $mytable)
        ...
        <tr style="border-bottom: 1px solid white;">
            ...
            <td class="table_tr" style="text-align: start; color: white;" title="(static)">
                @foreach ($mytable['result'] as $result)
