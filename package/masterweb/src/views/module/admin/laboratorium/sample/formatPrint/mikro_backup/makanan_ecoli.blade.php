...
<body style="margin: 10px; padding: 0">
    ...
    <table width="100%" cellspacing="0" cellpadding="0">
      ...
      <td>
        ...
        {{ $lab_string }}
        @else
        - /MakMin-Bak/{{ getRomawi(date('m')) }}/{{ date('Y') }}
        @endif
      </td>
    </tr> --}}
    ...
    <table width="100%" border="1" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <td style="text-align: center; width: 40%" colspan="{{ count($method_all) }}">Hasil Pemeriksaan
            </td>
      ...
      <td style="text-align: center; width: 15%" rowspan="2">Satuan</td> --}}
        ...
        @foreach ($table as $mytable)
            <tr>
                ...
                <!--Add The Line Below -->
                <?php
                // if($lastColumnPrinted == false): $lastColumnPrinted = true;
                ?>
                {{-- <td rowspan="{{ count($table) }}" style="text-align: center">
        @foreach ($method_all as $method)
        {{ $method->name_report }}: {!! $method->nilai_baku_mutu !!}<br>
        @endforeach
      ...
      <td rowspan="{{ count($table) }}" style="text-align: center">
        ...
        @endforeach
        <tr>
            <td style="text-align: center; width: 10%" colspan="2">Baku Mutu</td>
            {{-- <td style="text-align: center; width: 20%" rowspan="2">Jenis Sampel / Lokasi</td> --}}
            @foreach ($method_all as $method)
                <td style="text-align: center; width: 10%">
                    {!! $method->nilai_baku_mutu !!}
                </td>
            @endforeach
            {{-- <td style="text-align: center; width: 40%" colspan="{{ count($method_all) }}">Hasil Pemeriksaan
      </td> --}}
      ...
      <td style="text-align: center; width: 15%" rowspan="2">Satuan</td> --}}
        ...
        <tr>
            <td style="text-align: center; width: 10%" colspan="2">Satuan</td>
            {{-- <td style="text-align: center; width: 20%" rowspan="2">Jenis Sampel / Lokasi</td> --}}
            @foreach ($method_all as $method)
                <td style="text-align: center; width: 10%">
                    {!! $method->shortname_unit !!}
                </td>
            @endforeach
            {{-- <td style="text-align: center; width: 40%" colspan="{{ count($method_all) }}">Hasil Pemeriksaan
      </td> --}}
