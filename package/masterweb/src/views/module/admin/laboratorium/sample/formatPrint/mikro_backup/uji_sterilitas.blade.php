...
<body style="margin: 10px; padding: 0">
    ...
    <table width="100%" cellspacing="0" cellpadding="0">
      ...
      <td>
        ...
        {{ $lab_string }}
        @else
        - /Uji Sterilitas/{{ getRomawi(date('m')) }}/{{ date('Y') }}
        @endif
      </td>
    </tr> --}}
    ...
    <table width="100%" border="1" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <td style="text-align: center; width: 40%">Hasil Pemeriksaan Angka Kuman
            </td>
        ...
        @foreach ($table as $mytable)
            <tr>
                ...
                <td rowspan="{{ count($table) }}" style="text-align: center">
                    Negatif/ Tidak ditemukan adanya pertumbuhan kuman
                </td>
