...
<body style="margin: 10px; padding: 0">
    ...
    <table width="100%" cellspacing="0" cellpadding="0">
      ...
      <td>
        ...
        {{ $lab_string }}
        @else
        - /Usap Dinding/{{ getRomawi(date('m')) }}/{{ date('Y') }}
        @endif
      </td>
    </tr> --}}
    ...
    <table width="100%" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <td>
                ALT Usap Dinding, ALT Usap Lantai
            </td>
        </tr>
    </table>
    ...
    <table width="100%" border="1" cellspacing="0" cellpadding="0">
        ...
        @foreach ($table as $mytable)
            <tr>
                ...
                <td style="text-align: center">{!! $mytable['sample_type']->name_sample_type !!} <br> {!! $mytable['sample_type']->location_samples !!}</td>
