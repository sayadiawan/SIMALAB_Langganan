...
<body style="margin: 10px; padding: 0;">
    ...
    <table width="100%" cellspacing="0" cellpadding="0">
      ...
      <td>
        ...
        {{ $lab_string }}
        @else
        - /AM-BAK/{{ getRomawi(date('m')) }}/{{ date('Y') }}
        @endif
      </td>
    </tr> --}}
    ...
    <table width="100%" border="1" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <td style="text-align: center; width: 15%" rowspan="2">Baku Mutu</td>
        ...
        @foreach ($table as $mytable)
            <tr>
                ...
                <td style="text-align: center">
                    @if (isset($mytable['sample_type']->name_send_sample))
                        {!! $mytable['sample_type']->name_send_sample !!}<br>
                    @endif
                    @if (isset($mytable['sample_type']->location_samples))
                        {!! $mytable['sample_type']->location_samples !!}<br>
                    @endif
                    @if (isset($mytable['sample_type']->code_sample_customer))
                        {!! $mytable['sample_type']->code_sample_customer !!}
                    @endif
                </td>
