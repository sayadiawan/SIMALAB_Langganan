...
<body style="margin: 10px; padding:0">
    ...
    <table width="100%" cellspacing="0" cellpadding="0">
      ...
      <td>
        ...
        {{ $lab_string }}
        @else
        - /Usap Tangan/{{ getRomawi(date('m')) }}/{{ date('Y') }}
        @endif
      </td>
    </tr> --}}
    ...
    <table width="100%" border="1" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <td style="text-align: center; width: 20%">Nama / Lokasi</td>
            <td style="text-align: center; width: 40%">Perlakuan</td>
            <td style="text-align: center; width: 15%">Hasil Pemeriksaan</td>
            <td style="text-align: center; width: 15%">Satuan</td>
        </tr>
        ...
        @foreach ($table as $mytable)
            <tr>
                ...
                @foreach ($mytable['result'] as $result)
                    <td style="text-align: left">{{ $result['perlakuan_usap_tangan_sample_analitik_progress'] }}</td>
                @endforeach
                ...
                @foreach ($mytable['result'] as $result)
                    <td rowspan="{{ count($table) }}" style="text-align: center">{!! $result['satuan_bakumutu'] !!}</td>
                @endforeach
                <?php endif; ?>
            </tr>
    ...
    <table width="100%" cellspacing="0" cellpadding="0" style="margin-top: 10px; margin-bottom: 10px">
        <tr>
            <td style="text-align: left; width: 15%;vertical-align: text-top;">*Jumlah Mikroorganisme Pada Tangan</td>
        </tr>
    </table>
    ...
    <table width="100%" border="1" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <td style="text-align: left; width: 40%">Lokasi Pada Tangan</td>
            <td style="text-align: left; width: 40%">Kecepatan Mikroorganisme</td>
        </tr>

        <tr>
            <td style="text-align: center; width: 10%">1</td>
            <td style="text-align: left; width: 40%">Dibawah kuku jari</td>
            <td style="text-align: left; width: 40%">61.368 CFU/cm<sup>2</sup></td>
        </tr>

        <tr>
            <td style="text-align: center; width: 10%">2</td>
            <td style="text-align: left; width: 40%">Telapak tangan</td>
            <td style="text-align: left; width: 40%">847 CFU/cm<sup>2</sup></td>
        </tr>

        <tr>
            <td style="text-align: center; width: 10%">3</td>
            <td style="text-align: left; width: 40%">Punggung tangan</td>
            <td style="text-align: left; width: 40%">250 CFU/cm<sup>2</sup></td>
        </tr>

        <tr>
            <td style="text-align: center; width: 10%">4</td>
            <td style="text-align: left; width: 40%">Disela jari</td>
            <td style="text-align: left; width: 40%">223 CFU/cm<sup>2</sup></td>
        </tr>

        <tr>
            <td style="text-align: center; width: 10%">5</td>
            <td style="text-align: left; width: 40%">Diatas kuku jari</td>
            <td style="text-align: left; width: 40%">89 CFU/cm<sup>2</sup></td>
        </tr>
    </table>

    <table width="100%" cellspacing="0" cellpadding="0" style="margin-top: 10px; margin-bottom: 10px">
        <tr>
            <td style="text-align: left; width: 15%;vertical-align: text-top;">Sumber</td>
            ...
            <td style="text-align: left; width: 75%;vertical-align: text-top;">
                Number of Microorganisme on Your Hands, 2008, cyt Noah Fierer 2008
            </td>
        </tr>
    </table>
    <table width="100%" cellspacing="0" cellpadding="0">
