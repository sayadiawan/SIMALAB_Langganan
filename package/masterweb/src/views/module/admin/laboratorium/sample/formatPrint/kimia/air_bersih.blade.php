...
<body style="margin:50px 10px 50px 10px; padding: 0; font-size: 10pt">
                ...
                <td>
                    @php
                        $hasKimiaOrganik = $laboratoriummethods->contains(function ($laboratoriummethod) {
                            return $laboratoriummethod->jenis_parameter_kimia === 'kimia organik' &&
                                $laboratoriummethod->hasil !== '-';
                        });

                        $hasKimiawi = $laboratoriummethods->contains(function ($laboratoriummethod) {
                            return $laboratoriummethod->jenis_parameter_kimia === 'kimiawi' &&
                                $laboratoriummethod->hasil !== '-';
                        });
                    @endphp
    ...
    <table width="100%" cellspacing="0" cellpadding="0" border="1" style="margin-top: 10px">
        <thead>
            <tr>
                ...
                <th width="25%" style="text-align: center">KADAR MAKSIMUM <br>YANG DIPERBOLEHKAN</th>
                        ...
                        @if (
                            ...
                            @if ($hasil != '-')
                                <tr>
                                    ...
                                    <td width="20%" style="text-align: left; padding-left: 2px;">
                                        {!! $laboratoriummethod->name_report !!}
                                    </td>
    ...
    <span>Air Bersih mengacu Permenkes No. 2 Tahun 2023 tentang Pelaksanaan Peraturan Pemerintah Nomor 66 tentang Kesehatan Lingkungan</span>
    ...
    <div class="row batas" style="float: right; justify-content: center; margin-top: 20px;">
        <div class="col-md-12">
            <div class="justify-content-end" style="text-align: center;">
                ...
                @endphp
                Boyolali,
                {{ isset($validation) ? \Smt\Masterweb\Helpers\DateHelper::formatDateIndo($validation->stop_date) : $nullDate }}
                <br>
