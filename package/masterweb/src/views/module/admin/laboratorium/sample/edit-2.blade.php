          ...
          <li class="list-group-item">
            ...
            <div class="col-lg-12">
              <div class="form-check form-switch mb-4">
                <input class="form-check-input" type="checkbox" id="flexSwitchCheckDefault" name="changeSampleType">
                <label class="form-check-label" for="flexSwitchCheckDefault"
                       style="margin-left: 16px;">Ubah Jenis Sample dan Parameter</label>
              </div>
            </div>

            <div class="col-lg-12 mt-2 mb-4" id="display-jenis-sample" style="display: none">
              <div class="card">
                <div class="card-body">
                  <div class="col-lg-12">
                    <div class="form-group">
                  ...
                  <div class="is_paket" style="{{ isset($sample->packet_id) ? '' : 'display: none' }}">
                    <div class="col-lg-12">
                      <div class="form-group">
                        <div class="form-check form-check-flat form-check-primary">
                          <label class="form-check-label">
                            <input type="checkbox" class="form-check-input" id="isPaket"
                  ...
                  <div class="packet" style="{{ isset($sample->packet_id) ? '' : 'display: none' }}" id="inputPaket">
                    <div class="col-lg-12">
                      <div class="form-group">
            ...
            <div class="form-group" id="display-parameter" style="display: none">
...
@section('scripts')
  <script>
    ...
    $("#jenis_sampel").change(function() {
      ...
      // # 1. Initialization
      var code_sample_type = $(this).children(":selected").data('code');
      var old_code_sample = $('#code_sample').val();

      if (code_sample_type) {
        var cleaned_code_sample_type = code_sample_type.replace(/-/g, '');

        var new_code_sample = old_code_sample.replace(/\/([^\/-]+)-/, `/${cleaned_code_sample_type}-`);
        new_code_sample = new_code_sample.replace(/\s*-\s*/g, ' - ');
        new_code_sample = new_code_sample.replace(/\s+\/\s*/g, '/');

        $('#code_sample').val(new_code_sample);
      }
    ...
    $(document).ready(function() {
      ...
      document.getElementById('flexSwitchCheckDefault').addEventListener('change', function() {
        var showSample = document.getElementById('display-jenis-sample');
        var showParameter = document.getElementById('display-parameter');
        if (this.checked) {
          showSample.style.display = 'block';
          showParameter.style.display = 'block';
        } else {
          showSample.style.display = 'none';
          showParameter.style.display = 'none';
        }
      });

      document.getElementById('isPaket').addEventListener('change', function (){
        var showPacket = document.getElementById('inputPaket');

        if (this.checked){
          showPacket.style.display = 'block';
        }else {
          showPacket.style.display = 'none';
        }
      });

      $('#jenis_sampel').on('change', function () {
        var isPaket = document.getElementById('isPaket');
        isPaket.checked = false;

        methods_selected.forEach(data => {
          let checkbox = $(".checkbox-" + data['method_id']);
