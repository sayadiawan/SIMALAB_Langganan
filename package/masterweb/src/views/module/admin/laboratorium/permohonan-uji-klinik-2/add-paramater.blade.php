            ...
            <div class="row">
              ...
              <div class="col-md-6">
                ...
                <div class="col-md-12 form-group pt-3">
                  <div class="form-check">
                    <label class="form-check-label">
                      <input type="checkbox" class="form-check-input" name="jenis_parameters[{{ getPaketKlinik('Hematologi Rutin (Hb, Ht, Leko, AT, Index Eri)')->id_parameter_paket_klinik }}][pakets][]" value="{{ getPaketKlinik('Hematologi Rutin (Hb, Ht, Leko, AT, Index Eri)')->id_parameter_paket_klinik }}_{{ getPaketKlinik('Hematologi Rutin (Hb, Ht, Leko, AT, Index Eri)')->harga_parameter_paket_klinik }}">
                      Hematologi Rutin (Hb, Ht, Leko, AT, Index Eri)
                    </label>
                  </div>
                  <div class="form-check">
                    <label class="form-check-label">
                      <input type="checkbox" class="form-check-input" name="jenis_parameters[{{ getPaketKlinik('Diferensial Count (Hitung Jenins Lekosit)')->id_parameter_paket_klinik }}][pakets][]" value="{{ getPaketKlinik('Diferensial Count (Hitung Jenins Lekosit)')->id_parameter_paket_klinik }}_{{ getPaketKlinik('Diferensial Count (Hitung Jenins Lekosit)')->harga_parameter_paket_klinik }}">
                      Diferensial Count (Hitung Jenins Lekosit)
                    </label>
                  </div>
                  <div class="form-check">
                    <label class="form-check-label">
                      <input type="checkbox" class="form-check-input" name="jenis_parameters[{{ getPaketKlinik('Laju Endap Darah (LED)')->id_parameter_paket_klinik }}][pakets][]" value="{{ getPaketKlinik('Laju Endap Darah (LED)')->id_parameter_paket_klinik }}_{{ getPaketKlinik('Laju Endap Darah (LED)')->harga_parameter_paket_klinik }}">
                      Laju Endap Darah (LED)
                    </label>
                  </div>
                  <div class="form-check">
                    <label class="form-check-label">
                      <input type="checkbox" class="form-check-input" name="jenis_parameters[{{ getPaketKlinik('Golongan Darah A, B, O dan Rhesus')->id_parameter_paket_klinik }}][pakets][]" value="{{ getPaketKlinik('Golongan Darah A, B, O dan Rhesus')->id_parameter_paket_klinik }}_{{ getPaketKlinik('Golongan Darah A, B, O dan Rhesus')->harga_parameter_paket_klinik }}">
              ...
              <div class="col-md-3">
                ...
                <div class="col-md-12 form-group pt-3">
                  <div class="form-check">
                    <label class="form-check-label">
                      <input type="checkbox" class="form-check-input" name="jenis_parameters[{{ getPaketKlinik('Widal')->id_parameter_paket_klinik }}][pakets][]" value="{{ getPaketKlinik('Widal')->id_parameter_paket_klinik }}_{{ getPaketKlinik('Widal')->harga_parameter_paket_klinik }}">
                      Widal
                    </label>
                  </div>
                  <div class="form-check">
                    <label class="form-check-label">
                      <input type="checkbox" class="form-check-input" name="jenis_parameters[{{ getPaketKlinik('HBsAG Strip')->id_parameter_paket_klinik }}][pakets][]" value="{{ getPaketKlinik('HBsAG Strip')->id_parameter_paket_klinik }}_{{ getPaketKlinik('HBsAG Strip')->harga_parameter_paket_klinik }}">
                      HBsAG Strip
                    </label>
                  </div>
                  <div class="form-check">
                    <label class="form-check-label">
                      <input type="checkbox" class="form-check-input" name="jenis_parameters[{{ getPaketKlinik('Dengue NS1')->id_parameter_paket_klinik }}][pakets][]" value="{{ getPaketKlinik('Dengue NS1')->id_parameter_paket_klinik }}_{{ getPaketKlinik('Dengue NS1')->harga_parameter_paket_klinik }}">
                      Dengue NS1
                    </label>
                  </div>
                  <div class="form-check">
                    <label class="form-check-label">
                      <input type="checkbox" class="form-check-input" name="jenis_parameters[{{ getPaketKlinik('IgG Anti Dengue')->id_parameter_paket_klinik }}][pakets][]" value="{{ getPaketKlinik('IgG Anti Dengue')->id_parameter_paket_klinik }}_{{ getPaketKlinik('IgG Anti Dengue')->harga_parameter_paket_klinik }}">
                      IgG Anti Dengue
                    </label>
                  </div>
                  <div class="form-check">
                    <label class="form-check-label">
                      <input type="checkbox" class="form-check-input" name="jenis_parameters[{{ getPaketKlinik('IgM Anti Dengue')->id_parameter_paket_klinik }}][pakets][]" value="{{ getPaketKlinik('IgM Anti Dengue')->id_parameter_paket_klinik }}_{{ getPaketKlinik('IgM Anti Dengue')->harga_parameter_paket_klinik }}">
                      IgM Anti Dengue
                    </label>
                  </div>
                </div>
              ...
              <div class="col-md-3">
                ...
                <div class="col-md-12 form-group pt-3">
                  <div class="form-check">
                    <label class="form-check-label">
                      <input type="checkbox" class="form-check-input" id="urinalisisUrinRutin" name="jenis_parameters[{{ getPaketKlinik('Urinalisis Urin Rutin')->id_parameter_paket_klinik }}][pakets][]" value="{{ getPaketKlinik('Urinalisis Urin Rutin')->id_parameter_paket_klinik }}_{{ getPaketKlinik('Urinalisis Urin Rutin')->harga_parameter_paket_klinik }}">
                      Urine Rutin
...
{{--                  </div>--}}
                  <div class="form-check">
                    <label class="form-check-label">
                      <input type="checkbox" class="form-check-input" name="jenis_parameters[{{ getPaketKlinik('Test Kehamilan')->id_parameter_paket_klinik }}][pakets][]" value="{{ getPaketKlinik('Test Kehamilan')->id_parameter_paket_klinik }}_{{ getPaketKlinik('Test Kehamilan')->harga_parameter_paket_klinik }}">
                      Test Kehamilan
                    </label>
                  </div>
                  <div class="form-check">
                    <label class="form-check-label">
                      <input type="checkbox" class="form-check-input" name="jenis_parameters[{{ getPaketKlinik('Mikro Albumin')->id_parameter_paket_klinik }}][pakets][]" value="{{ getPaketKlinik('Mikro Albumin')->id_parameter_paket_klinik }}_{{ getPaketKlinik('Mikro Albumin')->harga_parameter_paket_klinik }}">
                      Mikro Albumin
                    </label>
                  </div>
                </div>
                    ...
                    success: function(response) {
                        if (response.status === true) {
                            swal({
                                ...
                                document.location =
                                    "{{ route('elits-permohonan-uji-klinik-2.index') }}";
                            });
                        } else {
