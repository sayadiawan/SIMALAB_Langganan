<table style="width: 100%">
    <thead>
        <tr>
            <th align="center" colspan="15"><b> HASIL DATA HAJI {{ strtoupper($nama_haji) }},
...
<table style="width: 100%">
    <thead>
        <tr style="background-color: green; border-collapse: collapse;">
            ...
            <th scope="col"
                ...
                Trigliserida</th>
            <th scope="col"
                style="background-color: orange; text-align: center; vertical-align: middle; width: 5cm; border: 1px solid black;">
                Laju Endap Darah 1 Jam</th>
            <th scope="col"
                style="background-color: orange; text-align: center; vertical-align: middle; width: 5cm; border: 1px solid black;">
                Laju Endap Darah 2 Jam</th>
            <th scope="col"
            ...
            {{-- <th scope="col" colspan="3" style="background-color: yellow; text-align: center; width: 10cm; border: 1px solid black;">No Amplop 2</th>
            <th scope="col" colspan="3" style="background-color: yellow; text-align: center; width: 10cm; border: 1px solid black;">No Amplop 3</th>
            <th scope="col" colspan="3" style="background-color: yellow; text-align: center; width: 10cm; border: 1px solid black;">No Amplop 4</th>
            <th scope="col" colspan="3" style="background-color: yellow; text-align: center; width: 10cm; border: 1px solid black;">No Amplop 5</th> --}}
    ...
    <tbody>
        ...
        <tr>
            ...
            <th style="text-align: left; border: 1px solid black; background-color: #00dbf8;">445.9</th>
