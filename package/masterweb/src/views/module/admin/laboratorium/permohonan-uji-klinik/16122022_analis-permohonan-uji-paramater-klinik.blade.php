                        ...
                        <tr>
                          <th colspan="6">
                            ...
                            <input type="hidden"
                              ...
                              value="{{ $item_satuan_klinik['id_permohonan_uji_parameter_klinik'] }}" readonly>
                          </th>
                        </tr>
                          ...
                          <tr>
                            <td style="width: 20%">
                              ...
                              <input type="hidden"
                                ...
                                value="{{ $item_subsatuan_klinik['id_permohonan_uji_sub_parameter_klinik'] }}" readonly>
                            </td>
                            ...
                            <td style="width: 15%">
                              ...
                              <input type="hidden" class="form-control"
                                ...
                                value="{{ $item_subsatuan_klinik['min_baku_mutu_detail_parameter_klinik'] }}" readonly>
                              <input type="hidden" class="form-control"
                                ...
                                value="{{ $item_subsatuan_klinik['max_baku_mutu_detail_parameter_klinik'] }}" readonly>
                              <input type="hidden" class="form-control"
                        ...
                        <tr>
                          ...
                          <td style="width: 15%">
                            ...
                            <input type="hidden" class="form-control"
                              ...
                              id="min_{{ $no }}" value="{{ $item_satuan_klinik['min'] }}" readonly>
                            <input type="hidden" class="form-control"
                              name="max[{{ $item_satuan_klinik['id_permohonan_uji_parameter_klinik'] }}]"
                              id="max_{{ $no }}" value="{{ $item_satuan_klinik['max'] }}" readonly>
                            <input type="hidden" class="form-control"
                              name="equal[{{ $item_satuan_klinik['id_permohonan_uji_parameter_klinik'] }}]"
                              id="equal_{{ $no }}" value="{{ $item_satuan_klinik['equal'] }}" readonly>
                          </td>
                          ...
                          <td style="width: 15%">
                            ...
                            @if ($item_satuan_klinik['satuan_permohonan_uji_parameter_klinik'] != null)
                              ...
                              <select class="form-control satuan_permohonan_uji_parameter_klinik"
                                ...
                                <option value="{{ $item_satuan_klinik['satuan_permohonan_uji_parameter_klinik'] }}"
                                  selected>
                                  {{ $item_satuan_klinik['nama_satuan_permohonan_uji_parameter_klinik'] }}</option>
                              </select>
                            @else
                              {{-- @php
                                dd($item_satuan_klinik->bakumutu->unit != null);
