                        ...
                        <tr id="row_non_sub_{{ $key_upns }}" class="tr_row">
                          ...
                          <td style="width: 15%">
                            <input type="text" class="form-control"
                              ...
                              value="{{ $item_upns->baku_mutu_permohonan_uji_parameter_klinik ?? old('baku_mutu_permohonan_uji_parameter_klinik') }}">
                          </td>
                ...
                @if (count($data_detail_uji_parameter_with_sub) > 0)
                  @foreach ($data_detail_uji_parameter_with_sub as $key_upws => $item_upws)
                    ...
                    @foreach ($item_upws->parametersatuanklinik->parametersubsatuanklinik as $key_pssk => $item_pssk)
                      <tr id="row_with_sub_{{ $key_upns }}" class="tr_row">
                        <td style="width: 20%">
                        ...
                        <td style="width: 15%">
                          <input type="text" class="form-control"
                            ...
                            value="{{ $item_upws->permohonanujisubparameterklinik->baku_mutu_permohonan_uji_sub_parameter_klinik ?? '-' }}"
                            readonly>
                        </td>
