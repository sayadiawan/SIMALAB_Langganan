  ...
  <div style="padding-top: 60px;">
        ...
        <td>
          <table width="100%" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td class="td-header">
                <span style="font-size: 11px;">
                  Jl. Ahmad Yani No.1 Kemiri, Mojosongo Telp. (0276) 320855 Boyolali 57311
                </span>
              </td>
            </tr>
            <tr>
    ...
    <div style="padding: 0px 40px 0px 40px;">
      <table style="margin: 5px 0px 5px 0px;" width="100%" cellspacing="0" cellpadding="0">
        <tr>
          <td style="
            ...
            text-align: center;
          ">
            <u>BLANGKO PERMINTAAN PEMERIKSAAN</u>
          </td>
        </tr>
      </table>
      ...
      <table style="font-size: 13px;" width="100%" cellspacing="0" cellpadding="0">
        <tr>
          <td width="33%">JENIS SAMPEL</td>
          <td width="2%">:</td>
          <td></td>
        </tr>
        <tr>
          <td width="33%">ASAL SAMPEL</td>
          <td width="2%">:</td>
          <td>
            <table width="100%" cellspacing="0" cellpadding="0">
              <tr>
    ...
    <div style="padding: 0px 30px 0px 30px;">
      ...
      <table style="font-size: 13px;" width="100%" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td>
            1. Membayar biaya administrasi sebesar Rp. ...................................
            <br>
            2. Hasil pemeriksaan selama 3 hari terhitung dari sampel diterima petugas
          </td>
        </tr>
        <tr><td>&nbsp;</td></tr>
        <tr>
      ...
      <table style="font-size: 13px;" width="100%" cellspacing="0" cellpadding="1">
        ...
        <tr>
          <td></td>
          <td>Kemasan dari plastik / Wadah yang steril bersih, Berat 250gr</td>
        </tr>
        <tr>
          <td></td>
