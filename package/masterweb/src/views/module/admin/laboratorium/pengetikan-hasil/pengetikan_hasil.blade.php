            ...
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a
                    href="{{ url('/elits-samples/verification', [Request::segment(2), Request::segment(3)]) }}">
                    Pengetikan
                    Hasil</a></li>
              ...
              <div class="col-md-12">
                ...
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <form
                      action="{{ route('elits-pengetikan-hasil.store', [Request::segment(2), Request::segment(3), Request::segment(4)]) }}"
                      method="POST">
                      @csrf
                      ...
                      <div class="form-group">
                        ...
                        <div class="input-group date">
                          <input type="text" class="form-control pengetikan_hasil_date" name="pengetikan_hasil_date"
                            id="pengetikan_hasil_date" placeholder="Isikan Tanggal Pengetikan Hasil"
...
@section('scripts')
  <script>
    $('.pengetikan_hasil_date').datepicker({
      format: 'dd/mm/yyyy'
    });
    $('.pengetikan_hasil_date').datepicker('update', new Date());
  </script>
@endsection
