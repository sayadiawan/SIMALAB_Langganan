                      ...
                      <div class="form-group parameter_jenis_card"
                        ...
                        <div class="card-body">
                          <button type="button" class="close"
                            ...
                            id="minus_{{ $value_parameterpaketjenisklinik->sort ?? $no_parent }}" data-dismiss="modal"
                            aria-label="Close">
                            <span aria-hidden="true">×</span>
                          </button>
                          <h5 class="card-title">
                            <center>Parameter Jenis Klinik {{ $value_parameterpaketjenisklinik->sort ?? $no_parent }}
                            </center>
                          </h5>
                          <div class="form-group">
                            ...
                            <select class="form-control"
                              ...
                              <option value="{{ $value_parameterpaketjenisklinik->parameter_jenis_klinik_id }}" selected>
                          ...
                          <div class="row"
                            ...
                            <div class="col-md-12">
                              <div
                                id="form-detail-parameter-satuan-paket-{{ $value_parameterpaketjenisklinik->sort ?? $no_parent }}"
                                class="mb-3">
                                          ...
                                          <script>
                                            $(function() {
                                              ...
                                              $("#parameter_jenis_klinik_{{ $no_parent }}").change(function(e) {
                                                $("#parameter_satuan_klinik_{{ $no_parent }}_{{ $no_child }}").val(0).trigger('change');
