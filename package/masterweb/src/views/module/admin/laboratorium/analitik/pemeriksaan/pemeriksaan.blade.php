              ...
              <div class="col-md-12">
                ...
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <form
                      action="{{ route('elits-pemeriksaan.store', [Request::segment(2), Request::segment(3), Request::segment(4)]) }}"
                      method="POST">
                      @csrf

                      <div class="form-group">
                        <label for="wadah_samples"><b>Pemeriksaan dilakukan:</b></label>

                        <div class="input-group date">
                          <input type="text" class="form-control pemeriksaan" name="pemeriksaan" id="pemeriksaan"
...
@section('scripts')
  <script>
    $('.pemeriksaan').datepicker({
      format: 'dd/mm/yyyy'
    });
    $('.pemeriksaan').datepicker('update', new Date());
  </script>
@endsection
