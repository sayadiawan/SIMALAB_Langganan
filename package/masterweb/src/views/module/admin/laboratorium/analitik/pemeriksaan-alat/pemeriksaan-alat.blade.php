              ...
              <div class="col-md-12">
                ...
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <form
                      action="{{ route('elits-pemeriksaan-alat.store', [Request::segment(2), Request::segment(3), Request::segment(4)]) }}"
                      method="POST">
                      @csrf

                      <div class="form-group">
                        <label for="wadah_samples"><b>Pemeriksaan alat dilakukan:</b></label>

                        <div class="input-group date">
                          <input type="text" class="form-control pemeriksaan_alat" name="pemeriksaan_alat"
                            id="pemeriksaan_alat" placeholder="Isikan Tanggal Pemeriksaan alat"
...
@section('scripts')
  <script>
    $('.pemeriksaan_alat').datepicker({
      format: 'dd/mm/yyyy'
    });
    $('.pemeriksaan_alat').datepicker('update', new Date());
  </script>
@endsection
