              ...
              <div class="col-md-12">
                ...
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <form
                      action="{{ route('elits-pipetase.store', [Request::segment(2), Request::segment(3), Request::segment(4)]) }}"
                      method="POST">
                      @csrf
                      <div class="form-group">
                        <label for="wadah_samples"><b>Pipetase dilakukan:</b></label>

                        <div class="input-group date">
                          <input type="text" class="form-control pipetase" name="pipetase" id="pipetase"
                            placeholder="Isikan Tanggal Pipetase" data-date-format="dd/mm/yyyy" required>
                      ...
                      <!-- <div class="form-group">
                                                      <label for="wadah_samples"><b>Apakah pipetase sudah siap?</b></label>

                                                      <div class="form-check">
                                                          <input class="form-check-input" name="pipetase" type="radio" value="ya" id="ya" >
                                                          <label class="form-check-label" for="flexCheckChecked">
                                                              Ya
                                                          </label>
                                                      </div>
                                                      <div class="form-check">
                                                          <input class="form-check-input" name="pipetase" type="radio" value="tidak" id="tidak" >
                                                          <label class="form-check-label" for="flexCheckChecked">
                                                              Tidak
                                                          </label>
                                                      </div>
...
@section('scripts')
  <script>
    ...
    $('.pipetase').datepicker('update', new Date());
  </script>
@endsection
