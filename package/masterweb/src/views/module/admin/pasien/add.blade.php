...
@section('content')
  ...
  <div class="card">
    <div class="card-body">
      <form enctype="multipart/form-data" class="forms-sample" id="form" action="{{ route('elits-pasien.store') }}"
        method="POST">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control no_rekammedis_pasien" name="no_rekammedis_pasien"
            id="no_rekammedis_pasien" placeholder="Nomor rekam medis" value="{{ old('no_rekammedis_pasien') }}">
        </div>
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control divisi_instansi_pasien" name="divisi_instansi_pasien"
            id="divisi_instansi_pasien" placeholder="Divisi/instansi" value="{{ old('divisi_instansi_pasien') }}">
        </div>
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="phone_pasien" name="phone_pasien"
            placeholder="Nomor telepon pasien.." value="{{ old('phone_pasien') }}">
        </div>
        ...
        <div class="form-group">
          ...
          <textarea class="form-control" name="alamat_pasien" id="alamat_pasien" cols="30" placeholder="Alamat pasien.."
            rows="10">{{ old('alamat_pasien') }}</textarea>
        </div>
