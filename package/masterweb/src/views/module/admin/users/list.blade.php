            ...
            <table id="order-listing" class="table">
              ...
              <tbody>
                ...
                <tr>
                    ...
                    <td>
                      <label class="bg-user">
                        <img src="{{ ($duser->photo == NULL) ? asset('assets/admin/images/logo/favicon.png') : asset('/storage/photo/'.$users->photo)}}" alt="image"/>
                      </label>
                    </td>
                    <td>
                      @if ($duser->publish == 1)
                    ...
                    <td>
                        <a href="{{url('adm-users/reset/'.$duser->id)}}">
                        ...
                        <form onsubmit="return confirm('Delete this user permanently?')" 
                            class="d-inline" 
                            action="{{route('adm-users.destroy', [$duser->id])}}" 
                            method="POST">
