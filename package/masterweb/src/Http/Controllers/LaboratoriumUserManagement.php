...
class LaboratoriumUserManagement extends Controller
{
  ...
  public function create()
  {
    ...
    return view('masterweb::module.admin.laboratorium.users.add', compact('user', 'privileges', 'laboratories'));
  }
  ...
  public function edit($id)
  {
    ...
    $laboratories = \Smt\Masterweb\Models\Laboratorium::all();
    return view('masterweb::module.admin.laboratorium.users.edit', compact('user', 'users', 'privileges', 'id', 'laboratories'));
  }
